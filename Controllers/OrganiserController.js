...
export const organiserLoginCheckController = async (req, res) => {
...
export const organiserRegisterController = async (req, res) => {
...
export const organiserLoginController = async (req, res) => {
    //Checking cookies
    const data = req.cookies.paaiTokenOrganiser;
...
export const organiserLogoutController = (req, res) => {
    const data = req.cookies.paaiTokenOrganiser;
...
export const dashboardAdminController = async (req, res) => {
